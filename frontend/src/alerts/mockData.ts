...
export const mockEvents: MockEventRow[] = [
  ...
  },
  {
    ...
    severity: "fatal",
    takeover_status: "processing",
    incident_state: "queued", // 排队样本：还没绑 run，接管列显「排队中」、操作列灰色
    agent_result: null,
    user_feedback: null,
    feedback_note: "",
  ...
  {
    // 处理中样本（诊断中已绑 run，蓝色可点）：与上面排队样本同桶同屏，演示三态区分
    alert_no: "ALM-20260730-000114",
    category: "Docker",
    alert_object: "gw-node-3",
    appid: "00000000000000000000000000000425",
    title: "网关容器 CPU 限流频发",
    description: "gw-node-3 上 gateway-edge-1 容器持续触发 CPU throttle，请求排队上升。",
    alert_status: "assigned",
    severity: "critical",
    takeover_status: "processing",
    incident_state: "diagnosing",
    ...
    user_feedback: null,
    feedback_note: "",
    detail_url: "https://alert.example.com/alerts/ALM-20260730-000114",
    incident_id: "inc_evt_114",
    matched_rule: { rule_id: "rule_gw_docker", name: "资源限制监控" },
    run_id: "run_alert_evt_114",
    run_clickable: true,
    started_at: iso(2, "09:40:05"),
    ended_at: null,
    duration_s: null,
    seen_count: 3,
    instance_id: GW_ID,
