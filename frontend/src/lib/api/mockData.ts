  ...
  mcps: {
    ...
    rows: [
      ...
      { id: "mcp_alarm_server", cells: [
        { text: "alarm-server" },
        { text: "alarm-server-v2", kind: "badge", tone: "warning" },
        { text: "https://mcpgateway.internal.example.com/servers/alarm-server-v2/mcp", mono: true, wrap: true },
...
export const adminMcpToolsRaw: Record<string, unknown>[] = [
  ...
  { tool_catalog_id: "tc_alarm_query", tool_name: "query_alarm", mcp_display_name: "alarm-server",
    mcp_version_id: "v_alarm", annotation_id: null, annotation_status: "unreviewed", is_approval_required: false },
  { tool_catalog_id: "tc_alarm_ack", tool_name: "ack_alarm", mcp_display_name: "alarm-server",
    mcp_version_id: "v_alarm", annotation_id: null, annotation_status: "unreviewed", is_approval_required: true },
